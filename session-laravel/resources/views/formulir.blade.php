...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="text-center"> WEB FRAMEWORK FORM VALIDATION </h1>
                <h3 class="text-center"> For testing Form validation </h3>
                <form action="{{ route('form-proses') }}" method="post">
                    ...
                    <button type="submit" class="btn btn-primary">Check Form</button>
                </form>
            </div>
        </div>
